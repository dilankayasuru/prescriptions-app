        ...
        <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-sm font-medium text-gray-600 dark:text-gray-200">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1" x-data="{
                    ...
                    <div class="h-96 rounded overflow-hidden flex items-center justify-center bg-neutral-200 dark:bg-neutral-700">
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b border-gray-200 dark:border-gray-600">
                                        <th class="text-left py-3 px-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Drug Name</th>
                                        <th class="text-left py-3 px-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Dosage</th>
                                        <th class="text-left py-3 px-2 text-sm font-medium text-gray-700 dark:text-gray-300">
