<x-layouts.app :title="__('Prescription Details')">
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            ...
            @if (!$prescription->quotation && auth()->user()->userRole === 'admin')
            ...
            <div>
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            <p class="text-sm font-medium mb-2 text-neutral-500 dark:text-neutral-300">Prescription ID
                            </p>
                            ...
                            @if ($prescription->delivery_address)
                                <div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-600 dark:text-gray-400">Address</span>
                                    </div>
